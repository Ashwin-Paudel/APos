...
namespace apos {
    namespace keycodes {
        ...
        const int KEY_EQUAL = 0x0D;
        const int KEY_SQUARE_OPEN_BRACKET = 0x1A;
        const int KEY_SQUARE_CLOSE_BRACKET = 0x1B;
        const int KEY_SEMICOLON = 0x27;
        const int KEY_BACKSLASH = 0x2B;
        const int KEY_COMMA = 0x33;
        const int KEY_DOT = 0x34;
        const int KEY_FORESLHASH = 0x35;
        ...
        const int KEY_KEYPAD_5 = 0x4C;
        const int KEY_KEYPAD_MUL = 0x37;
        const int KEY_KEYPAD_Minus = 0x4A;
        const int KEY_KEYPAD_PLUS = 0x4E;
        const int KEY_KEYPAD_DIV = 0x35;
